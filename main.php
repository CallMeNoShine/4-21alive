...
<body>
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-danger">
            ...
            <a class="dropdown-item" href="map/normal.php">Mon - Fri</a>
            <a class="dropdown-item" href="map/holiday.php">Sat - Sun</a>
            <div class="dropdown-divider"></div>
            <h6 class="dropdown-header">Tourist Attractions</h6>
            <a class="dropdown-item" href="map/niman.php">Niman</a>
            <a class="dropdown-item" href="map/chaingmai_wall.php">Old City</a>
        </div>
    </div>
    
    <iframe class="map" src="https://www.google.com/maps/d/embed?mid=13LjP_tkCltfMGbwJ0p0E_ZQn1Y4RPhUS" width="90%" height="720" frameborder="0" style="border:0" allowfullscreen></iframe>
